...
//		return GenericValidator.isEmail(email);
     ...
     * @param message
     */
    public static ModelAndView alertAndClose(String message, HttpServletResponse res) throws IOException {
        res.setContentType("text/html;charset=UTF-8");
        alertAndClose(message, res.getWriter(), DEFAULT_ALERT_TITLE);
        return null;
    }

    public static void alertAndClose(String message, PrintWriter w, String title) {
        message = message.replaceAll("\"", "'").replaceAll("\\\\n", "<br>");
